          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
            ...
            <div className="p-10">
              ...
              <div className="mt-10 flex gap-4 flex-wrap">
                <button className="px-8 py-3 rounded-2xl bg-green-500 text-white font-semibold shadow hover:scale-105 transition">
                  Buy & Pay Now
                </button>

                <button className="px-8 py-3 rounded-2xl bg-orange-500 text-white font-semibold shadow hover:scale-105 transition">
                  Buy & Add to Khata
                </button>
              </div>
            </div>
